...
class AppLocalizationsEs extends AppLocalizations {
  ...
  @override
  String get noInternetRetry => 'Reintentar';
  ...
  @override
  String get reminderFiredBody => '¡Es hora de tu recordatorio!';

  @override
  String reminderFiredEarlyTitle(String title) {
    return 'En 10 minutos: $title';
  }
  ...
  @override
  String get authErrorFillAllFields => 'Rellena todos los campos.';
  ...
  String friendsRemoveConfirmMessage(String name) {
    return '¿Seguro que quieres eliminar a $name de tus amigos?';
  }
